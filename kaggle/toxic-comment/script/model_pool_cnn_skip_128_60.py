...
def get_model(embedding_lookup_table, dropout, spatialDropout):
    ...
    conv_1k = Conv1D(filters=60, kernel_size=1, padding='same', activation='relu')(merge_1)
    conv_2k = Conv1D(filters=60, kernel_size=2, padding='same', activation='relu')(merge_1)
    conv_3k = Conv1D(filters=60, kernel_size=3, padding='same', activation='relu')(merge_1)
    conv_4k = Conv1D(filters=60, kernel_size=4, padding='same', activation='relu')(merge_1)
    conv_5k = Conv1D(filters=60, kernel_size=5, padding='same', activation='relu')(merge_1)
