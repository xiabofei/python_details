...
def get_model(embedding_lookup_table, dropout, spatialDropout):
    ...
    # First level conv
    conv_1k = Conv1D(filters=190, kernel_size=1, padding='same', activation='relu')(embedding_layer)
    conv_2k = Conv1D(filters=190, kernel_size=2, padding='same', activation='relu')(embedding_layer)
    conv_3k = Conv1D(filters=190, kernel_size=3, padding='same', activation='relu')(embedding_layer)
